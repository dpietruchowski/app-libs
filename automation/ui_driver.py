...
libs/automation/uiautomationserver.h) and started with its port env var set.
...
Examples:
    ...
    # control the app clock (needs libs/utils TimeProvider)
...
# This file lives in <repo>/libs/automation/, so the consuming repo is two up.
